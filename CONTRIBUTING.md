# Contributing to Aero Arc Protos

Thank you for contributing to Aero Arc. Keep protocol changes focused, update
generated clients when schemas change, and discuss breaking changes in an issue
before implementation.

## Development

Create a branch from `master`, then run the project checks before opening a
pull request:
